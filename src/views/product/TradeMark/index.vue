<template>
  <div>
    <el-button type="primary" icon="el-icon-plus" style="margin-left: 5px" @click="showDialog(null)"
      >添加</el-button
    >
    <el-table style="width: 100%" border :data="list">
      ...
      <el-table-column prop="prop" label="操作" width="width">
        <template slot-scope="{row}">
          <el-button type="warning" icon="el-icon-edit" size="mini" @click="showDialog(row)"
            >修改</el-button
          >
